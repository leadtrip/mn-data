...
insert into activity(id, name, date_created, location_id) values (uuid_generate_v4(), 'Brick session 1', now(), (select id from location where name = 'Bath park'));
insert into activity(id, name, date_created, location_id) values (uuid_generate_v4(), 'Easy run', now(), (select id from location where name = 'Melksham campus'));
